...
import 'package:chessudoku/core/utils/chess_utils.dart';
import 'package:chessudoku/presentation/theme/difficulty_theme.dart';
...
class QuickPlayButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final chessPiece = ChessUtils.fromDifficulty(difficulty);
