import 'package:chessudoku/data/repositories/puzzle_repository_impl.dart';
import 'package:chessudoku/data/repositories/record_repository_impl.dart';
...
final loadingNotifierProvider = StateNotifierProvider<LoadingNotifier, LoadingState>(
  (ref) => LoadingNotifier(),
);

// 기록 관련 프로바이더
final recordsNotifierProvider = StateNotifierProvider<RecordsNotifier, RecordsState>(
  (ref) => RecordsNotifier(),
);
...
final puzzleRepositoryProvider = Provider<PuzzleRepository>(
  (ref) => PuzzleRepositoryImpl(ref.watch(cacheServiceProvider)),
);
