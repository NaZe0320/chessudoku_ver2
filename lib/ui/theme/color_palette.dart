...
class AppColors {
  // 브랜드 컬러
  static const primary = Color(0xFF1A3367); // 딥 네이비
  static const primaryLight = Color(0xFF2C4B8C); // 라이트 네이비
  ...
  static const success = Color(0xFF007E6D); // 성공/완료
  ...
  static const onSurface = Color(0xFF1F2937); // 표면 위 텍스트
